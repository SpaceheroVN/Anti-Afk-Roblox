...
local function createOrGetUi()
	...
	local screenGui,tempFrame; local success,result=pcall(function()
		...
		local lbl=Instance.new("TextLabel",tempFrame); lbl.Name="StatusLabel"; lbl.AutomaticSize=Enum.AutomaticSize.XY; lbl.AnchorPoint=Vector2.new(0.5,1); lbl.Position=UDim2.new(0.5,0,0,UI_ICON_SIZE.Y.Offset+10); lbl.BackgroundColor3=Color3.fromRGB(40,40,40); lbl.BackgroundTransparency=0.5; lbl.Font=Enum.Font.SourceSansSemibold; lbl.TextSize=UI_TEXT_SIZE; lbl.TextColor3=Color3.new(1,1,1); lbl.Text="Hx: "..currentPresetName; local lp=Instance.new("UIPadding",lbl); lp.PaddingTop,lp.PaddingBottom,lp.PaddingLeft,lp.PaddingRight=UDim.new(0,3),UDim.new(0,3),UDim.new(0,6),UDim.new(0,6); local lc=Instance.new("UICorner",lbl); lc.CornerRadius=UDim.new(0,6)
