...
if not player then print("Hx_V.0.4: Lỗi - Không tìm thấy LocalPlayer."); _G.UnifiedAntiAFK_AutoClicker_Running = false; return end
...
local Config = {
    ...
    GuiTitle = "Hx_V.0.4", NotificationDuration = 4, AnimationTime = 0.2, IconAntiAFK = "rbxassetid://117118515787811", IconAutoClicker = "rbxassetid://117118515787811",
...
local function cleanup()
    ...
    State.Connections = {}
    State.EspConnections = {}
    if State.GuiElements.ScreenGui and State.GuiElements.ScreenGui.Parent and State.GuiElements.ScreenGui.Name == "Hx_V.0.4_GUI" then pcall(State.GuiElements.ScreenGui.Destroy, State.GuiElements.ScreenGui) end
...
task.spawn(function()
    ...
    if not success then
        print("Hx_V.0.4 LỖI KHỞI TẠO:", err)
