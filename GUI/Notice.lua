...
local Config = {
    ...
    IconSuccess = "rbxassetid://15229232932",
    IconWarning = "rbxassetid://15229234832",
    IconError = "rbxassetid://15229231238",
...
local function getContainer()
    ...
    moduleState.ScreenGui.DisplayOrder = 9999
